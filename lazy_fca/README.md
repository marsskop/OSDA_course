...
* (Very) good solution (7-8 pts.):
  * [ ] Improve the baseline algorithm:
    * [x] Achieve better asymptotic time complexity;
    * [x] Improve the runtime of examples comparison:
    * [x] Rewrite the intersections of sets into the intersection of the corresponding bitmasks. Would it make the algorithm faster?\
...
* Perfect solution (9-10 pts.)
  ...
  * [x] Compare the proposed algorithm with at least 3  popular rule-based models.
